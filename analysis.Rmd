...
search <- athletes %>% filter(
  grepl('katherine', name, ignore.case = TRUE) | grepl('martha', name, ignore.case = TRUE),
  grepl('USA', nations)
  )
